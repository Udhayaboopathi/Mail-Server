...
export function Topbar({ onCompose }: { onCompose?: () => void }) {
  ...
  return (
    <header className="flex flex-col gap-4 border-b border-black/10 bg-white/70 px-4 py-4 backdrop-blur lg:flex-row lg:items-center lg:justify-between lg:px-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button
          className="bg-sand text-ink hover:bg-sand/80"
